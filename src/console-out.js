  ...
  function displayHelpScreen() {
    console.log(
      [
        ...
        '  --completion           ' +
          chalk.dim('Method to handle bash/zsh/whatever completions'),
        '  --cwd                  ' +
          chalk.dim(
            'Directory from which relative paths are calculated against'
          ),
        '  --require              ' +
          chalk.dim(
            'String or array of modules to require before running plop'
          ),
        '',
        chalk.bold('Examples:'),
        '  $ ' + chalk.blue('plop'),
